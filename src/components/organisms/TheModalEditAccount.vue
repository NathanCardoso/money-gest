  ...
  >
    <form class="form">
      ...
      <TheInputField
        ...
        v-model="dataEditAccount.accountBalance"
      />
    </form>
  </TheModal>
</template>
...
<script lang="ts">
import type { IModalCreateOrEditAccountData } from '~/interface/organisms/TheModalCreateOrEditAccount'
...
export default {
  ...
  methods: {
    ...
    handleSubmit(): void {
      this.$emit("modal-card:submit", this.dataEditAccount)
    }
  }
}
</script>
